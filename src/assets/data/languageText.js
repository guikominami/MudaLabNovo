export const homeText = {
  "portuguese": {
    ...
    body1: "É com base nessa visão que apostamos no diálogo entre a" +
    ...
    body2: "Eletrônica, fabricação digital, robótica e programação aliados à sustentabilidade, à inclusão, à mobilização social" +
  ...
  "english": {
    ...
    body1: "É com base nessa visão que apostamos no diálogo entre a" +
           ...
           " experimentos e traquitanas que têm como premissa a transformação" +
           "social, cultural e ambiental. ",
    body2: "É com base nessa visão que apostamos no diálogo entre a" +
           "educação e a tecnologia para desenvolver cursos, projetos," +
           " experimentos e traquitanas que têm como premissa a transformação" +
           "social, cultural e ambiental. "       
  }  
