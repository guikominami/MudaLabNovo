  ...
  return (
    <SectionComponent>
      ...
      <SubText>
        ...
        promovidos pela Câmara de Lisboa e que envolvem várias áreas do conhecimento.
      </SubText>
      <SubText>
      ...
      <SubText>Montagem de um sistema solar offgrid.</SubText>
      <Container>
        <CarouselTutorial imagesCarousel={TUTORIAL_ENERGIA_SOLAR_DATA} />
      </Container>
      <Title>Lanterna Solar</Title>
      <SubText>Montagem de uma lanterna solar.</SubText>
      <Container>
        <ImageContainer>
      ...
      <Title>Roboino</Title>
      <SubText>
        Robô com motores controlado por bluetooth. <br></br>Link para o código
        do Arduino:
        <a
          href="https://github.com/guikominami/Arduino/tree/2ad64d5f580ad274ffda10e275891389effda6af/Roboino"
          target="_blank"
          rel="noreferrer"
        >
      ...
      <SubText>Sensor de luminosidade.</SubText>
      <Container>
        <ImageContainer>
      ...
      <SubText>Sensor de presença e luminosidade.</SubText>
      <Container>
        <ImageContainer>
      ...
      <SubText>Sensor de presença.</SubText>
      <Container>
        <ImageContainer>
      ...
      <SubText>Sensor de umidade.</SubText>
      <Container>
        <ImageContainer>
